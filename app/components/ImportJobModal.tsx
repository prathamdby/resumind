  ...
  return (
    ...
    >
      <div className="space-y-2">
        <h2 className="text-xl font-semibold text-slate-900">Import details</h2>
        <p className="text-sm text-slate-600">
          Enter a job posting URL or upload a PDF job description. We'll extract
          the company name, position, and description.
        </p>
      </div>
